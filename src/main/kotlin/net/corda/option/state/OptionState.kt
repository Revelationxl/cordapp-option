...
data class OptionState(
        ...
        val spot: Amount<Currency> = Amount(0, strike.token),
    ...
    //infix fun `spot moved to`(spot: Amount<Currency>) = copy(spot = spot)
    infix fun `with notary`(notary: Party) = TransactionState(this, notary)
